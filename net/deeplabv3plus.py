...
class DeepLabv3Plus(nn.Module):
    def __init__(self, orig_resnet, dilate_scale=16, num_classes=2, output_dim=256):
        ...
        self.input_convert = nn.Conv2d(1, 3, 1)
    ...
    def forward(self, x):
        # with ResNet-101 Encoder
        x = self.resnet_relu1(self.resnet_bn1(self.resnet_conv1(self.input_convert(x))))
